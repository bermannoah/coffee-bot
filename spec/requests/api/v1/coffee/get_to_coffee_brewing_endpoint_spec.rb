...
describe 'coffee_brewing endpoint GET requests' do
  context 'GET /api/v1/coffee_brewing' do
    it 'returns a brew with /last_brewed' do
      ...
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: 'delicious!')
    ...
    it 'returns only the most recent brew with /last_brewed' do
      ...
      user = Fabricate(:slack_login_user, team_id: team.id)
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: 'delicious!')
      second_brew = Fabricate(:brew, team: team, user_name: user.username, location: 'Turing', description: 'so good!')
      data = {
        team_id: '1234',
        team_domain: team.team_name,
        user_id: user.id,
    ...
    it 'returns multiple brews with /last_brewed if given a number' do
      ...
      user = Fabricate(:slack_login_user, team_id: team.id)
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: 'delicious!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'Turing', description: 'so good!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'The Moon', description: 'made me feel weightless!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: 'best!')
      data = {
        team_id: '1234',
        team_domain: team.team_name,
        user_id: user.id,
    ...
    it 'returns only the number of brews requested for /last_brewed' do
      team = Fabricate(:team, team_slack_id: '1234')
      user = Fabricate(:slack_login_user, team_id: team.id)
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: '#1 delicious!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'Turing', description: '#2 so good!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'The Moon', description: '#3 made me feel weightless!')
      Fabricate(:brew, team: team, user_name: user.username, location: 'Home', description: '#4 best!')
      data = {
        team_id: '1234',
        team_domain: team.team_name,
        user_id: user.id,
